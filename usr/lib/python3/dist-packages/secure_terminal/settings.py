...
low-numbered user file (20_auto-generated.conf): it beats the system seeds, and a
user can still hand-maintain a higher-numbered .conf (e.g. 50_user.conf) that
overrides even the app's own choices.
...
# a hand-maintained file (e.g. 50_user.conf) that overrides the app's choices.
_USER_FILE = '20_auto-generated.conf'
...
def save(values, locked=()):
    ...
    try:
        ...
        lines = [
            '## Automatically generated by secure-terminal. Do NOT edit -- this',
